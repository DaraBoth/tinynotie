...
export const api = {
  ...
  telegramMiniAppLogin: (initData, config = {}) => apiClient.post('/auth/telegram-miniapp-login', { initData }, config),
  ...
  getGroupUsers: (groupId) => apiClient.get('/api/getGroupUsers', { params: { group_id: groupId } }),
  updateGroupVisibility: (data) => apiClient.post('/api/updateGroupVisibility', data),
  updateGroupUserPermission: (data) => apiClient.post('/api/updateGroupUserPermission', data),
  transferGroupAdmin: (data) => apiClient.post('/api/transferGroupAdmin', data),
